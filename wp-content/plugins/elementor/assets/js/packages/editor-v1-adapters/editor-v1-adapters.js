...
/*!*******************************************************************!*\
  ...
  \*******************************************************************/
__webpack_require__.r(__webpack_exports__);__webpack_require__.d(__webpack_exports__,{__privateDispatchReadyEvent:function(){return dispatchReadyEvent;},__privateFlushListeners:function(){return flushListeners;},__privateGetCurrentEditMode:function(){return getCurrentEditMode;},__privateIsRouteActive:function(){return isRouteActive;},__privateListenTo:function(){return listenTo;},__privateOpenRoute:function(){return openRoute;},__privateRegisterRoute:function(){return registerRoute;},__privateRunCommand:function(){return runCommand;},__privateSetReady:function(){return setReady;},__privateUseIsPreviewMode:function(){return useIsPreviewMode;},__privateUseIsRouteActive:function(){return useIsRouteActive;},__privateUseListenTo:function(){return useListenTo;},__privateUseRouteStatus:function(){return useRouteStatus;},commandEndEvent:function(){return commandEndEvent;},commandStartEvent:function(){return commandStartEvent;},editModeChangeEvent:function(){return editModeChangeEvent;},routeCloseEvent:function(){return routeCloseEvent;},routeOpenEvent:function(){return routeOpenEvent;},v1ReadyEvent:function(){return v1ReadyEvent;},windowEvent:function(){return windowEvent;}});var react__WEBPACK_IMPORTED_MODULE_0__=__webpack_require__(/*! react */"react");function isJQueryDeferred(value){return!!value&&"object"===typeof value&&Object.hasOwn(value,"promise")&&Object.hasOwn(value,"then")&&Object.hasOwn(value,"fail");}
...
function registerRoute(route){const extendedWindow=window;if(!extendedWindow.$e?.routes?.register){return Promise.reject("`$e.routes.register()` is not available");}
const routeParts=route.split("/");if(routeParts.length<2){return Promise.reject(`\`${route}\` is an invalid route`);}
const componentRoute=routeParts.pop();const component=routeParts.join("/");try{return Promise.resolve(extendedWindow.$e.routes.register(component,componentRoute,()=>null));}catch(e){return Promise.reject(e);}}
...
function useRouteStatus(route,{blockOnKitRoutes=true,blockOnPreviewMode=true}={}){const isRouteActive2=useIsRouteActive(route);const isKitRouteActive=useIsRouteActive("panel/global");const isPreviewMode=useIsPreviewMode();const isActive=isRouteActive2&&!(blockOnPreviewMode&&isPreviewMode);const isBlocked=blockOnPreviewMode&&isPreviewMode||blockOnKitRoutes&&isKitRouteActive;return{isActive,isBlocked};}}();(window.elementorV2=window.elementorV2||{}).editorV1Adapters=__webpack_exports__;})();